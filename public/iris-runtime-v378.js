(() => {
  ...
  window.fetch=async (...args)=>{
    ...
    // Once Vercel has positively blocked Blob, status/model polling and button actions
    // are answered locally for the rest of this page session. A reload performs one
    // real request again, which is enough to detect that storage access has recovered.

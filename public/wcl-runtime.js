...
function applyAll() {
  ...
  applying = true;
  try {
    removeRosterIntelligenceOutsideComposition();applyShell();applyCommandCenter();window.applyPullLabSource?.();applyDamageHealing();applyComposition();applyLive();applySupplemental();applyIntelligence();removeRosterIntelligenceOutsideComposition();applyDataTruthScrub();

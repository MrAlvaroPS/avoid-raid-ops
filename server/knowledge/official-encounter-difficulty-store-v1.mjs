...
export const OFFICIAL_ENCOUNTER_DIFFICULTY_STORE_VERSION='official-encounter-difficulty-store-v1';
...
export async function loadLatestOfficialEncounterDifficultyViewV1(journalEncounterId,difficultyId,{storageGet=corpusGet}={}){return storageGet(officialEncounterDifficultyLatestKeyV1(journalEncounterId,difficultyId));}

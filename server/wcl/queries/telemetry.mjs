...
query AvoidTelemetryMeta($code:String!){reportData{report(code:$code,allowUnlisted:true){code startTime endTime guild{id name} masterData{actors{id name type subType server} abilities{gameID name icon type}} fights(killType:Encounters){id encounterID name difficulty kill startTime endTime fightPercentage bossPercentage averageItemLevel inProgress lastPhaseAsAbsoluteIndex phaseTransitions{id startTime} friendlyPlayers friendlySpecs friendlyItemLevels wipeCalledTime}}}}`;

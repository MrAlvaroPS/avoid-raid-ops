...
test('index preserves historical styles and activates the v3.8.9.1 hotfix bootstrap before shared WCL data runtime',async()=>{
...
test('v3.8.9.1 has one visible release-label owner and component runtimes cannot fight it',async()=>{
  ...
  assert.match(pkg,/"version": "0\.3\.8-9-vercel\.1"/);assert.match(pkg,/"iris": "node --env-file=\.env\.local scripts\/iris-local-worker\.mjs"/);

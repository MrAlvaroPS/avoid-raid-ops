...
test('v3.8.6 package metadata is active while v3.8.5 shared runtime filenames remain historical assets',async()=>{
  ...
  assert.match(pkg,/"version": "0\.3\.8-6-vercel\.0"/);assert.match(pkg,/"iris": "node --env-file=\.env\.local scripts\/iris-local-worker\.mjs"/);

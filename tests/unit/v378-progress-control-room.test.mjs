...
test('v3.7.8 assets remain additive while a newer strategic Progress runtime is active', async () => {
  ...
  assert.match(index, /progress-runtime-v3713\.js\?v=3\.8\.0|progress-runtime-v37(?:9|10|11|12|13)\.js\?v=3\.7\.(?:9|10|11|12|13)/);
  assert.match(index, /iris-runtime-v3713\.js\?v=3\.8\.0|iris-runtime-v37(?:9|10|11|12|13)\.js\?v=3\.7\.(?:9|10|11|12|13)/);

...
test('v3.7.7 assets remain available while a newer Iris runtime may be active', async () => {
  ...
  assert.ok(styles.includes('/raidops-v377.css?v=3.7.7'),'v3.7.7 CSS must remain an audited compatibility source');
  assert.match(index,/raidops-active\.css\?v=3\.9\.2-css1/);
  assert.doesNotMatch(index,/raidops-v377\.css\?v=3\.7\.7/);
  assert.match(index, /iris-runtime-v3713\.js\?v=3\.8\.(?:5|9\.1)|iris-runtime-v37(?:7|8|9|10|11|12|13)\.js\?v=3\.7\.(?:7|8|9|10|11|12|13)/);

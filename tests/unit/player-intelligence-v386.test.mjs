...
test('v3.8.8 Players renders full roster and cannot self-trigger an infinite MutationObserver loop under v3.8.10 package',async()=>{
  ...
  assert.equal(JSON.parse(pkg).version,'0.3.8-10-vercel.0');
});

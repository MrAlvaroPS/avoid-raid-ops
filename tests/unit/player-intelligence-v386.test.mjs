...
test('v3.8.8 Players remains historical while v3.9.2 owns the active dossier and Reliability presentation under later v3.9 overlays',async()=>{
  ...
  assert.match(JSON.parse(pkg).version,/^0\.3\.9-(?:[4-9]|\d{2,})-vercel\.0$/);
});
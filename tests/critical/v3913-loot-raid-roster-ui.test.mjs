...
test('Loot v3.9.13.7 is current-raid scoped, HOME-history roster scoped and simulates one raider at a time',async()=>{
  ...
  assert.match(loader,/loot-runtime-v39137\.js\?v=3\.9\.13\.7/);

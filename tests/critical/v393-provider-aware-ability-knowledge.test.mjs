...
test('CRITICAL v3.9.3 SOURCES: Lorrgs runtime and Parse Wowhead wrapper retain explicit trust boundaries',()=>{
...
test('CRITICAL v3.9.3 CAPABILITIES: preview is network-free and resolution requires explicit approval',()=>{
...
test('CRITICAL v3.9.3 DOCS: provider metadata cannot become combat truth, Deep coverage or automatic promotion',async()=>{
  ...
  assert.match(route,/ability-knowledge-service/);assert.match(pkg,/"version": "0\.3\.9-3-vercel\.0"/);
});

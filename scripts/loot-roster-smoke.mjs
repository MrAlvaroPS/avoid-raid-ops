...
if(simulateCount){
  console.log(`\nSimulating first ${Math.min(simulateCount,eligible.length)} eligible RAID members with official SimulationCraft...`);

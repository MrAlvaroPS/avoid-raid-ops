...
const files = [
  ...
  'routes/api/wcl/report.js','routes/api/wcl/telemetry.js','routes/api/wcl/history.js','routes/api/wcl/intelligence.js','routes/api/wcl/status.js','routes/api/wcl/corpus.js','routes/api/wcl/reports.js','routes/api/knowledge.js','routes/api/iris/capabilities.js','routes/api/iris/sources.js',

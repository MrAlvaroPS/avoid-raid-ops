...
console.log('\n[1/4] Load persisted Episode (0 network)');
...
console.log('\n[2/4] Load compatible Matched Null controls (0 network)');
...
console.log('\n[3/4] Re-evaluate Matched Null from stored evidence');
...
console.log('\n[4/4] Build Independent Evidence Groups');
...
if(args.persist){
  ...
  const stored={...groups,storage:{kind:'independent-evidence-groups-revision',revisionKey,latestKey}};
...
console.log('\nOK: Independent Evidence Groups validation completed entirely from persisted evidence.');

...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('command-center-history-bridge','/command-center-runtime.js?v=4.0.0-migration6-transport1','command-center','command-center','command-center-progression-and-history-writer','promote-stable-transport-to-source-owner',{authority:'migration-bridge'}),

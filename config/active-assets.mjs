...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('mechanics-defensives-fallback-bridge','/mechanics-defensives-fallback-bridge-v4.js?v=4.0.0-migration4-shadow1','split-source-owners','mechanics-defensives-fallback','mechanics-source-parity-shadow-and-defensive-writer-shadow','retire-after-both-source-owners-are-live',{authority:'migration-bridge'}),
  asset('mechanics-source-runtime','/mechanics-runtime.js?v=4.0.0-migration4-shadow1','mechanics-source','mechanics','source-owned-presentation-parity-shadow','promote-after-green-parity-checkpoint',{authority:'migration-source-shadow',sourceOwner:'apps/web/src/features/mechanics/runtime.js'}),

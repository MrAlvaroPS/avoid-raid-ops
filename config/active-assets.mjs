...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('mechanics-defensives-fallback-bridge','/mechanics-defensives-fallback-bridge-v4.js?v=4.0.0-migration5-owner1','split-source-owners','mechanics-defensives-fallback','post-owner-retirement-hold-noop','retire-after-post-owner-green-validation',{authority:'migration-bridge'}),

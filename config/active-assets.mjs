...
export const ACTIVE_STYLES=Object.freeze([
  ...
  asset('css-v34','/raidops-v34.css?v=3.4.2','compatibility-cascade','cross-screen','readability-composition-data-truth-bootstrap-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v35','/raidops-v35.css?v=3.6.2','mechanics-corpus','mechanics','corpus-workbench-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v37','/raidops-v37.css?v=3.7.0','mechanics-corpus','mechanics','corpus-learning-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v373','/raidops-v373.css?v=3.7.3','mechanics-corpus','mechanics','encounter-intelligence-v373-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v374','/raidops-v374.css?v=3.7.4','mechanics-corpus','mechanics','encounter-live-status-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v375','/raidops-v375.css?v=3.7.5','mechanics-corpus','mechanics','encounter-readability-live-work-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v376','/raidops-v376.css?v=3.7.6','compatibility-cascade','cross-screen','global-readability-iris-storage-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v377','/raidops-v377.css?v=3.7.7','iris','cross-screen','corpus-standby-feedback-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v378','/raidops-v378.css?v=3.7.8','progress','progress','progress-control-room-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v379','/raidops-v379.css?v=3.7.9','progress','progress','progress-historical-live-boundary-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v3710','/raidops-v3710.css?v=3.7.10','progress','progress','strategic-progress-explicit-controls-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v3711','/raidops-v3711.css?v=3.7.11','progress','progress','canonical-progress-readonly-indicators-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v3712','/raidops-v3712.css?v=3.7.12','progress','progress','progress-data-integrity-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v3713','/raidops-v3713.css?v=3.8.5','progress','progress','progress-readability-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v386','/raidops-v386.css?v=3.8.6','players','players','player-dossier-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v390','/raidops-v390.css?v=3.9.0','data-platform','cross-screen','shared-card-rhythm-data-activity-shell-overlay','visual-equivalence-required',{authority:'overlay'}),
  asset('css-v392','/raidops-v392.css?v=3.9.2','players','players','players-dossier-reliability-hotfix-overlay','visual-equivalence-required',{authority:'overlay'}),
]);
...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('corpus-ui-stability','/corpus-ui-stability-v1.js?v=1.1.0','mechanics-corpus','mechanics-page-guard','mechanics-only-corpus-visibility-guard','retire-after-page-ownership-is-source-native',{authority:'guard'}),

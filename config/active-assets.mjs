...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('mechanics-defensives-fallback-bridge','/mechanics-defensives-fallback-bridge-v4.js?v=4.0.0-migration4-owner1','split-source-owners','mechanics-defensives-fallback','defensive-fallback-and-writer-shadow','retire-after-both-source-owners-are-live',{authority:'migration-bridge'}),

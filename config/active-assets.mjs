...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('mechanics-defensives-fallback-bridge','/mechanics-defensives-fallback-bridge-v4.js?v=4.0.0-migration5-shadow1','split-source-owners','mechanics-defensives-fallback','defensive-source-parity-shadow-trigger','retire-after-both-source-owners-are-live',{authority:'migration-bridge'}),
  asset('defensive-audit-source-runtime','/defensive-audit-runtime.js?v=4.0.0-migration5-shadow1','defensive-audit-source','defensive-audit','defensive-audit-source-parity-shadow','keep-stable-source-owned-transport',{authority:'migration-source-shadow',sourceOwner:'apps/web/src/features/defensive-audit/runtime.js'}),

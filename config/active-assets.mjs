...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('pull-lab-source-shadow','/pull-lab-runtime.js?v=4.0.0-migration7-shadow1','pull-lab-source','pull-lab','pull-lab-parity-shadow-non-authoritative','promote-after-browser-parity',{authority:'source-shadow',sourceOwner:'apps/web/src/features/pull-lab/runtime.js'}),

...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('pull-lab-source-runtime','/pull-lab-runtime.js?v=4.0.0-migration7-owner1','pull-lab-source','pull-lab','single-source-pull-lab-presentation','keep-stable-source-owned-transport',{authority:'source-owner',sourceOwner:'apps/web/src/features/pull-lab/runtime.js'}),
  asset('defensive-audit-source-runtime','/defensive-audit-runtime.js?v=4.0.0-migration5-owner1','defensive-audit-source','defensive-audit','single-source-defensive-audit-presentation','keep-stable-source-owned-transport',{authority:'source-owner',sourceOwner:'apps/web/src/features/defensive-audit/runtime.js'}),
  asset('mechanics-source-runtime','/mechanics-runtime.js?v=4.0.0-migration4-owner1','mechanics-source','mechanics','single-source-mechanics-presentation','keep-stable-source-owned-transport',{authority:'source-owner',sourceOwner:'apps/web/src/features/mechanics/runtime.js'}),
  asset('command-center-source-runtime','/command-center-runtime.js?v=4.0.0-migration6-owner1','command-center-source','command-center','single-source-command-center-progression-history','keep-stable-source-owned-transport',{authority:'source-owner',sourceOwner:'apps/web/src/features/command-center/runtime.js'}),

...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('command-center-history-bridge','/command-center-history-bridge-v4.js?v=4.0.0-migration1','command-center','command-center-history','deduplicated-raid-session-command-center-writer','move-to-command-center-source-owner',{authority:'migration-bridge'}),

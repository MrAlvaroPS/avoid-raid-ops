...
export const ACTIVE_LOCAL_SCRIPTS=Object.freeze([
  ...
  asset('progress-legacy-retirement','/progress-legacy-retirement-v4.js?v=1','progress-migration','progress','temporary-execution-retirement-guard','delete-with-retired-legacy-writers',{authority:'guard'}),
